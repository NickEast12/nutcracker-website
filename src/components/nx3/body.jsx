  ...
  return (
    <BodyStyles>
        <div className="wrapper">
            <h3>At Nutcracker we know that in today's competitive market, gaining and holding onto market share requires more than just eye-catching campaigns. It demands a strategic, integrated approach that guides your audience from first impression to loyal customer. That's why we created  nx³, a streamlined strategy designed to help businesses like yours  attract attention, build engagement, and  convert leads into lasting relationships.</h3>
            <div className="body">
                <div className="logo">
                <XLogo />
                </div>
                ...
                <div className='video'>
                    <video
                        ...
                        src="https://TickedPink.b-cdn.net/NX3_shutter07.mp4"
                        autoPlay
                        muted
                        // loop
                    ></video>
    ...
    .wrapper {
        ...
        .card {
            ...
            .background-2 {
                ...
                background: linear-gradient(55deg, rgba(43,165,162,1) 0%, rgba(43,165,162,1) 49%, #FBE100 100%);
            }
            .background-3 {
                background: #FBE100;
            }
