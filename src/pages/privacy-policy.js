...
const PrivacyPolicy = () => (
  <Layout>
    ...
    <Legal title="Privacy Policy" date="28-Apr-2021">
      <section>
        <p>
          This Privacy Policy describes the policies of Nutcracker Agency Ltd,
          Salatin House 19 Cedar Road Sutton, Surrey SM2 5DA, United Kingdom of
          Great Britain and Northern Ireland (the), email:
          hello@nutcrackeragency.com, phone: 020 3941 0305 on the collection,
          use and disclosure of your information that we collect when you use
          our website ( https://www.nutcrackeragency.com/ ). (the “Service”). By
        ...
        <section>
          ...
          <p>
            ...
            years after user accounts remain idle or for as long as we need it
            to fulfill the purposes for which it was collected as detailed in
        ...
        <section>
          ...
          <p>
            ...
            hello@nutcrackeragency.com. We will respond to your request in
